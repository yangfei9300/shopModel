	...
	<view>
		<view class="colonn">
			<view class="roww border_bottom inputview center_center">
				...
				src="/static/wd_gr@2x.png" @click.stop="selimg(1)" style="border-radius: 50%" class="w-110 h-110"></image>
				<image v-else @click.stop="selimg(1)" :src="BASE_IMG + userInfo.avatar" style="border-radius: 50%" class="w-110 h-110"></image>
			</view>
			<view class="roww border_bottom inputview">
				<view>姓名</view>
				<view class="w-20"></view>
				<input class="allline inoutal" v-model="userInfo.name" placeholder="请输入姓名" />
			</view>
			<view class="roww border_bottom inputview">
				<view>昵称</view>
				<view class="w-20"></view>
				<input class="allline inoutal" v-model="userInfo.nickName" placeholder="请输入昵称" />
			</view>
			<view class="roww border_bottom inputview">
				<view>手机号</view>
				<view class="w-20"></view>
			...
			<!-- <view class="roww border_bottom inputview">
				<view>密码</view>
				<view class="w-20"></view>
				<input class="allline inoutal" v-model="userInfo.password" placeholder="请输入密码" />
			</view> -->
			<!-- <view class="roww w-750 background1">
				...
				>
					...
					<image mode="aspectFill" v-if="!userInfo.wximg " 
					src="/static/1721233392382.png" class="w-300 h-550"></image>
					<image mode="aspectFill" v-else :src="userInfo.wximg" 
					class="w-300 h-550"></image>
				...
				>
					...
					<view>支付宝收款码</view>
					<view class="h-20"></view>
					<image mode="aspectFill" v-if="!userInfo.aliimg" 
					src="/static/1721233392382.png" class="w-300 h-550"></image>
