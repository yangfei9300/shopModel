	...
	<view>
		<view class="colonn p-all-40">
			...
			<view class="colonn">
				...
				@click.stop="listTypeClick(1)"
				>
					<view class="yudd"></view>
					<view class="w-10"></view>
					<view class="yuemx">佣金记录</view>
					<image 
					:src="listType==1?'/static/zhishiqis.png':'/static/zsqx.png'" 
					
					class="w-50 h-50"></image>
					<view class="allline"></view>
				</view>
				<view class="h-31"></view>
				<view class="jiluitem colonn m-bottom-30"
				 v-for="(item, index) in kickbackList" v-if="listType==1">
					<view class="m-all-20 border_bottom p-bottom-20" 
				...
				<view class="h-56"></view>
				<view class="roww center_center"
				@click.stop="listTypeClick(2)">
					<view class="yudd"></view>
					<view class="w-10"></view>
					<view class="yuemx">余额明细</view>
					<image
					:src="listType==2?'/static/zhishiqis.png':'/static/zsqx.png'" 
				...
				<view class="h-56"></view>
				<view class="roww center_center"
				@click.stop="listTypeClick(3)"
				>
					<view class="yudd"></view>
					<view class="w-10"></view>
					<view class="yuemx">余额充值</view><image 
					:src="listType==3?'/static/zhishiqis.png':'/static/zsqx.png'" 
